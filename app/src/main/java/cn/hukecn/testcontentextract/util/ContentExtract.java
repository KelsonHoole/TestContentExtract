package cn.hukecn.testcontentextract.util;
...
public class ContentExtract {
	 ...
	 * @return 网页正文string
	 */
	public static JSONObject parse(String _html) {
	 ...
	 * @return 网页正文string
	 */
	public static JSONObject parse(String _html, boolean _flag) {
		flag = _flag;
		html = _html;
		preProcess();
//		System.out.println(html);
	...
	private static JSONObject getText() {
...
//						break;
		...
		try {
			...
			jsonObject.put("length",indexDistribution.size());
			jsonObject.put("start",start);
			jsonObject.put("end",end);
			jsonObject.put("lines",lines.size());
			jsonObject.put("threshold",threshold);
			jsonObject.put("blocksWidth",blocksWidth);
